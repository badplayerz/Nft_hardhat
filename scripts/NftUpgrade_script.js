 ...
 * @LastEditTime: 2022-07-19 11:04:38
...
async function main() {
  ...
  const NFT = await hre.ethers.getContractFactory("NftUpgrade");

  console.log("正在发布NftUpgrade...");
  const proxy = await upgrades.deployProxy(NFT, ["NftUpgradeNFT","NftUpgrade",1000], { initializer: 'initialize' });
